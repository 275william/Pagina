...
<body>
    <section id="home">
        <div class="contenido">
            ...
            <div class="presentacion">
                ...
                <h2>Soy <span>William Steven Cortes Ruiz</span> Ingeniero de sistemas</h2>
    ...
    <section id="about">
        ...
        <div class="info_sobreMi">
            ...
            <h2>Soy, <span>william steven cortes ruiz</span></h2>
            <h3>Slogan</h3>
    ...
    <section id="contactus">
        ...
        <div class="contact-container">
            ...
            <div class="contact-card">
                ...
                <span class="contact-card-data">wilcor275@gmail.com</span>
            </div>

            <div class="contact-card">
                <i class='bx bxl-whatsapp contact-card-icon'></i>
                <h3 class="contact-card-title">Whatsapp</h3>
                <span class="contact-card-data">(+57) 3212315146</span>
            </div>
